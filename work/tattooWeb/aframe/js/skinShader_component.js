...
AFRAME.registerShader('skin', {
    init: function (data) {
        ...
        var mapHeight = textureLoader.load( "img/human_spec.jpg" );

        mapHeight.anisotropy = 4;
        mapHeight.wrapS = mapHeight.wrapT = THREE.RepeatWrapping;
        mapHeight.format = THREE.RGBFormat;

        var mapSpecular = textureLoader.load( "img/human_spec.jpg" );

        mapSpecular.anisotropy = 4;
        mapSpecular.wrapS = mapSpecular.wrapT = THREE.RepeatWrapping;
        mapSpecular.format = THREE.RGBFormat;

        var mapColor = textureLoader.load( "img/human_col.jpg" );
